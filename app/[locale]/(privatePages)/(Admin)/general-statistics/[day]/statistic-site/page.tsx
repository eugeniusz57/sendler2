					...
					userHistoryDetails.map((item, index) => {
						return (
							...
							>
								...
								<p data-title="Дати відправки :" className="md:w-48 px-[10px] py-3 md:p-0 text-right md:text-left border-b-2 border-[#B5C9BE] md:border-none before:content-[attr(data-title)] before:float-left md:before:content-none before:font-bold">{item.sending_group_date}</p>
