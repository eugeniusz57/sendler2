      ...
      <div className="flex flex-col md:gap-[80px] gap-[50px] md:mt-[60px] mt-[28px] ">
        <div className="sms-page-box ">
          <div className="flex gap-8">
            <div>
              <p className="lg:w-[724px] md:w-[640px] w-[308px] text-mainTextColor dark:text-textColorDarkTheme md:text-base text-sm md:leading-6 leading-[21px] font-montserrat">
                {t('textUserNameBox')}
              </p>
              <p className=" text-mainTextColor dark:text-textColorDarkTheme font-normal lg:text-xl  md:text-lg sm:text-base md:mt-[50px] mt-[40px] label">
                {t('titleUserNameInput')}
              </p>
              <div className="flex flex-col md:flex-row  md:gap-[22px] gap-6 items-center md:mt-3 mt-2">
                <div className="md:w-[474px] w-[308px] dark:border-none">
                  <Select
              ...
              {!(
                user?.alfa_names_disable?.length === undefined ||
            ...
            {user?.alfa_names_disable?.length ? (
              <div className="hidden lg:block text-mainTextColor dark:text-textColorDarkTheme text-base font-montserrat">
        ...
        <div className="sms-page-box">
          ...
          <p className=" text-mainTextColor dark:text-textColorDarkTheme font-normal md:text-xl text-base md:mt-[50px] mt-[28px] lg:mb-[3px] md:mb-8 mb-[20px]">
            {t('titleInputSmsSendBox')}
          </p>
          <div className="flex lg:flex-row flex-col-reverse md:gap-8 gap-[20px]">
            <div className=" inline-block  lg:w-[636px] md:w-[596px] w-[308px] mt-1">
              <div className="flex justify-end gap-5 font-roboto md:text-sm text-[12px] text-mainTextColor dark:text-textColorDarkTheme">
                {' '}
                <span>
            ...
            <div className="md:flex lg:flex-col md:flex-row gap-[18px] lg:justify-center md:justify-start">
              <div className="text-base md:mb-0 mb-4 text-mainTextColor dark:text-textColorDarkTheme leading-6">
                {t('tileOperations')}
              </div>
              <div className="flex lg:flex-col md:flex-row gap-[18px] lg:justify-center md:justify-start">
                <button
                  ...
                  className="text-base text-emailColorLink dark:text-darkLink cursor-pointer leading-6"
                >
                  {t('operation_1')}
                </button>
                <button
        ...
        <div className="sms-page-box">
          <p className="lg:w-[724px] md:w-[640px] text-mainTextColor dark:text-textColorDarkTheme md:text-base text-sm md:leading-6 leading-[21px] font-montserrat">
            {t('textRecipientsFormBox')}
          </p>
          <p className=" text-mainTextColor dark:text-textColorDarkTheme font-normal lg:text-xl md:text-lg text-base leading-6 md:mt-[50px] mt-[28px]">
          ...
          {isChecked && (
            <div className="mt-5 flex lg:flex-row flex-col lg:items-center items-start">
              ...
              <div className="md:mb-3 mb-2">
                <label
                  htmlFor="calendar"
                  className="flex items-center text-xl text-mainTextColor dark:text-textColorDarkTheme cursor-pointer "
                >
                  <div>{t('titleInputDate')}</div>
                  <div className="w-auto h-auto">
                    <Image
                      ...
                      height={24}
                      alt="Check box"
                      className="ml-2 mr-4 dark:invert"
                    />
                  </div>
                </label>
              </div>
              <div>
                <DatePicker
                  ...
                  className="xl:w-[454px] lg:w-[250px] md:w-[160px] w-[306px] h-12 lg:mb-0 md:mb-[50px] mb-[28px] rounded-[18px] dark:border-none border border-inputBorder outline-none text-xl text-center text-mainTextColor dark:text-textColorDarkTheme cursor-pointer"
                />
              </div>
              <p className=" text-xl text-mainTextColor dark:text-textColorDarkTheme  md:ml-5 md:mr-2 md:mb-3 mb-2">
                {t('titleInputTimeBox')}
              </p>
      ...
      <div className="flex justify-center items-center flex-col mt-[50px]">
        <div className="flex lg:items-center items-start gap-1 mb-4">
          ...
          <div className="md:text-base text-sm md:leading-6 leading-[21px]">
            ...
            <span
              onClick={openModal}
              className={`text-emailColorLink dark:text-darkLink md:text-base text-sm md:leading-6 leading-[21px] ml-1 cursor-pointer`}
            >
