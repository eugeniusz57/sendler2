...
const UserAccountPage: React.FC = () => {
	...
	const data = [
		{ name: t('circleDiagram_text_1'), value: user?.rejected_sms },
		{ name: t('circleDiagram_text_2'), value: user?.delivered_sms },
		{ name: t('circleDiagram_text_3'), value: user?.pending_sms },
	];
