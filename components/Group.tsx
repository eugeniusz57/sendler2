...
const Group = ({ group, getGroups }: Props) => {
	return (
		<li className="block lg:flex w-full gap-x-6 lg:gap-x-0 px-[26px] items-center lg:h-[48px] text-base font-montserrat font-normal border-b border-rowUnderLine">
			<div data-title='Група' className="w-full md:w-3/5 lg:w-1/6 lg:mt-0 mt-[22px] lg:mb-0 mb-[22px] lg:text-left text-center overflow-hidden before:content-[attr(data-title)] before:float-left lg:before:content-none before:font-bold before:w-2/5 before:text-left">
