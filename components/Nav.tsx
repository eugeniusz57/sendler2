...
const Nav: React.FC = () => {
	...
	return (
		<>
			<nav className={`flex justify-between lg:items-center container mx-auto`}>
				{isOpen && (
					<div className="min-w-[134px] lg:min-w-[156px] h-[49px] lg:h-[51px]">
						<LogoNav />
					</div>
				)}
				<div className={`flex justify-end lg:items-center container mx-auto relative`}>
					{isOpen && (
					...
					<div className="hidden lg:flex items-center">
						<ul
							className={`mr-4 lg:mr-12 xl:mr-16 lg:py-0 lg:h-auto bg-bgFooter lg:flex lg:justify-center lg:items-center lg:gap-4 xl:gap-10 lg:static lg:bg-transparent lg:w-auto text-center text-[22px] lg:text-base xl:text-lg font-medium lg:font-normal leading-[33px] lg:leading-6 lg:pt-0 Lg:pl-0`}
						>
					...
					<div className="hidden lg:block w-[70px] h-full lg:ml-4">
						<SelectLanguage
							openSelect={(a: boolean) => a}
							selectOptions={locales}
							selectedOption={locale}
					...
					{withWindow !== undefined && withWindow > 1160 && (
						<SwitchTheme
							theme={theme}
							isToggled={isToggled}
							setTheme={setTheme}
