...
const QuestionSegment: React.FC<Props> = ({ title, desc, email }) => {
	...
	return (
		<>
			...
			>
				<h3 className="w-[276px] md:w-[575px] lg:max-w-none text-base lg:text-xl md:text-lg font-roboto block">{title}</h3>
			...
			<p
				className={` text-sm md:text-[16px] w-full mt-3 lg:mt-[18px] lg:pr-[196px] pb-4 lg:pb-5 ${expanded ? "hidden " : " blok"
					}`}
			>
				{desc}
				{email && (
