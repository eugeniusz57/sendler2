		...
		try {
			...
			if (res.data.users.length !== 0) {
				...
				if (credentialsRes && !credentialsRes.error) {
					router.push(`/${locale}/user/${userId}/mailing-list`);
	...
	return (
		...
		>
			<div className="text-left w-full mb-8">
				...
				>
					{t('input_2')}<span className=" text-redStar">*</span>
				</label>
				<div className="flex relative">
				...
				<label
					...
					className="font-roboto text-xs md:text-sm font-medium mb-2  mt-8 block"
				>
					{t('input_3')}<span className=" text-redStar">*</span>
				</label>
				<div className="flex relative">
					<input
						id="email"
				...
				<label
					...
					className="font-roboto text-xs md:text-sm font-medium mb-2  mt-8 block"
				>
					{t('input_4')}<span className=" text-redStar">*</span>
				</label>
				<div className="flex relative">
					<input
						id="login"
				...
				<label
					...
					className="font-roboto text-xs md:text-sm font-medium mb-2  mt-8 block"
				>
					{t('input_5')}<span className=" text-redStar">*</span>
				</label>
				<div className="flex relative">
					<input
						id="password"
				...
				<label
					...
					className="font-roboto text-xs md:text-sm font-medium mb-2  mt-8 block"
				>
					{t('input_6')}<span className=" text-redStar">*</span>
				</label>
				<div className="flex relative">
					<input
						id="repeatPassword"
